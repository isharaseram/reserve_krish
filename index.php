...
<!--					<a href="#price_break_hotel_room_1" rel="prettyPhoto[inline]">-->
...
<!--                                        </a>-->
			...
			<!-- END .home-reservation-box -->
                ...
                <div class="lightbox-title"><h4 class="title-style4">Availability<span class="title-block"></span></h4></div>
                                               ...
                                               $sepdate =$date->format("Y-m-d");
                                                ...
                                                while ($row1 = mysql_fetch_array($result1)) {
                                                 ...
                                                 if (($row1['total']==NULL)&& ($row1['bang']==NULL)) {
                                                     ?>
                                               <tr>
                                            <td data-title="Column 1"><?php  echo $sepdate; ?></td>
                                            <td data-title="Column 1"><?php  echo "5 rooms OR Bungalow is Available"; ?></td>
					</tr>      
                                                     <?php
...
//                                                     echo $sepdate."- 5 rooms OR Bungalow is Available"."<br>";
                                               ...
                                               <tr>
                                            <td data-title="Column 1"><?php  echo $sepdate; ?></td>
                                            <td data-title="Column 1"><?php  echo "Bungalow is Reserved"; ?></td>
					</tr>      
                                                     <?php
                                               ...
                                               <tr>
                                            <td data-title="Column 1"><?php  echo $sepdate; ?></td>
                                            <td data-title="Column 1"><?php  echo $row1['total']."rooms Available"; ?></td>
					</tr>      
                                                     <?php
									...
									<div id="price_break_hotel_room_1" class="hide">
										...
										<div class="lightbox-title"><h4 class="title-style4">Please Login to Do the Reservation<span class="title-block"></span></h4></div>
										<div class="page-content">
										
                                                                                    <form method="post" action="login.php">
                                                                                        <input class="bookbutton" name="Book" type="submit" value="Login" /> 
                                                                                    </form>
										</div>
